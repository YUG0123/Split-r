...
import { ArrowDownCircle, ArrowUpCircle } from "lucide-react"; // Removed Link icon here
import Link from "next/link"; // Fixed: Imported the correct Next.js Link component
        ...
        <div>
          ...
          <div className="space-y-3">
            {oweDetails.youAreOwedBy.map((item) => (
              // Fixed: Added unique key prop and backticks for the dynamic URL string
              <Link
                key={item.userId}
          ...
          <div className="space-y-3">
            {oweDetails.youOwe.map((item) => (
              ...
              >
                ...
                {/* Changed text color to red-600 since this indicates owing money */}
